...
export default function Home() {
    ...
    return (
        <PageTransition>
            <div className="bg-[#111827] text-[#F5E6C8] font-sans antialiased overflow-hidden min-w-0 w-full relative">

                {/* BACKGROUND DETAILS: Subtle Gold Lights & Vignette */}
                <div className="absolute top-0 inset-x-0 h-[100vh] bg-gradient-to-b from-[#D4AF37]/5 via-transparent to-transparent pointer-events-none -z-10" />
                <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-[#D4AF37]/3 blur-[140px] rounded-full pointer-events-none -z-10" />
                <div className="absolute bottom-[30%] right-[-10%] w-[600px] h-[600px] bg-[#D4AF37]/3 blur-[160px] rounded-full pointer-events-none -z-10" />

                {/* Fine Cinematic Grid overlay */}
                <div className="absolute inset-0 opacity-[0.015] bg-[linear-gradient(to_right,#D4AF37_1px,transparent_1px),linear-gradient(to_bottom,#D4AF37_1px,transparent_1px)] bg-[size:4rem_4rem] pointer-events-none -z-10" />
                ...
                <section className="relative min-h-[95vh] flex items-center pt-32 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full relative z-10">
                        ...
                        <div className="lg:col-span-8 space-y-10 text-left">
                            ...
                            >
                                <span className="text-[10px] font-mono tracking-[0.25em] text-[#D4AF37] uppercase bg-[#D4AF37]/10 px-3 py-1 rounded-full border border-[#D4AF37]/20">
                            ...
                            <div className="relative">
                                ...
                                >
                                    <span className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.8rem] xl:text-[4.8rem] 2xl:text-[5.5rem] font-black tracking-tighter uppercase leading-[0.8] text-gradient-gold select-none">
                                        MUSIC
                                    </span>
                                    <span className="hidden md:inline-block w-16 h-1 bg-gradient-to-r from-[#D4AF37] to-transparent translate-y-[-12px]" />
                                </motion.div>
                            </div>
                            ...
                            <motion.p
                                ...
                                className="text-[#F5E6C8]/80 text-base md:text-xl max-w-xl leading-relaxed font-light"
                            >
                            ...
                            >
                                <MagneticButton>
                                    <Link
                                        to="/music"
                                        className="inline-flex items-center gap-3 bg-gradient-to-r from-[#D4AF37] to-[#F5D97A] text-[#111827] font-black text-sm md:text-base px-10 py-4.5 rounded-full shadow-lg shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/35 transition-all duration-300"
                                    >
                ...
                <section className="py-32 border-t border-white/5 bg-[#1B1F24]/30 relative">
                        ...
                        <FadeIn>
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative">
                                ...
                                <div className="hidden lg:block absolute left-[-60px] top-6 select-none origin-left -rotate-90">
                                    <span className="text-[9px] font-mono tracking-[0.3em] text-[#D4AF37]/30 uppercase block">
                                ...
                                <div className="lg:col-span-8 space-y-6">
                                    ...
                                    <h2 className="text-4xl sm:text-6xl md:text-[5.25rem] font-black text-white leading-[0.95] uppercase tracking-tighter">
                                        ...
                                        <span className="flex flex-wrap items-center gap-4">
                                            <span>RELEASE</span>
                                            <span className="inline-block w-20 md:w-32 h-[45px] md:h-[65px] rounded-full overflow-hidden border border-[#D4AF37]/40 bg-[#111827]">
                                                <img
                                ...
                                <div className="lg:col-span-4 pt-4 lg:pt-24 space-y-8 text-left">
                                    <p className="text-[#F5E6C8]/80 text-base md:text-lg leading-relaxed font-light">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-mono tracking-widest text-[#D4AF37]/60">CREATIVE FREEDOM</span>
                                    </div>
                                </div>
                ...
                <section className="py-32 border-t border-white/5 bg-[#111827] relative">
                    <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-16">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative">
                            ...
                            <motion.div
                                ...
                                className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-[1px] bg-gradient-to-b from-[#D4AF37]/40 via-[#D4AF37]/10 to-transparent origin-top -translate-x-1/2"
                            />
                            ...
                            <FadeIn direction="left">
                                <div className="space-y-6 pr-0 lg:pr-16 text-left group">
                                    <div className="flex justify-between items-baseline border-b border-white/5 pb-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-full border border-[#D4AF37]/20 flex items-center justify-center text-[#D4AF37] group-hover:bg-[#D4AF37]/10 transition-colors">
                                                <Eye className="w-4 h-4" />
                                            </div>
                                            <h3 className="text-2xl text-white font-extrabold uppercase tracking-wide">Vision</h3>
                                        </div>
                                        <span className="text-4xl md:text-7xl font-mono font-extralight text-[#D4AF37]/15 select-none">01</span>
                                    </div>
                            ...
                            <FadeIn direction="right">
                                <div className="space-y-6 pl-0 lg:pl-16 text-left group mt-8 lg:mt-16">
                                    <div className="flex justify-between items-baseline border-b border-white/5 pb-4">
                                        ...
                                        <span className="text-4xl md:text-7xl font-mono font-extralight text-[#D4AF37]/15 select-none">02</span>
                                    </div>
                                    <p className="text-slate-400 text-base md:text-lg leading-relaxed font-light">
                ...
                <section className="py-32 border-t border-white/5 bg-[#1B1F24]/10">
                    <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-16">
                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                                <div className="space-y-3">
                                    ...
                                    <h2 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tight">
                                        LATEST FROM <span className="text-gradient-gold">UNSTOPPABLE</span>
                                    </h2>
                                </div>
                                <MagneticButton>
                                    <Link
                                        to="/music"
                                        className="inline-flex items-center gap-2 text-sm md:text-base font-bold text-[#D4AF37] hover:text-[#F5D97A] group transition-colors shrink-0"
                                    >
                                ...
                                <FadeIn>
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-2 text-left pt-2">
                                            ...
                                            <h4 className="text-2xl md:text-3xl font-black text-white uppercase tracking-wide group-hover:text-[#F5D97A]">
                                ...
                                {featuredPreviews.slice(1).map((release, index) => (
                                    <FadeIn key={index} delay={index * 0.15}>
                                        <div className="flex items-center gap-6 group/item text-left">
                                            <div className="w-28 h-28 md:w-36 md:h-36 rounded-2xl overflow-hidden border border-white/5 bg-[#1B1F24] shrink-0">
                                            ...
                                            <div className="space-y-1.5 min-w-0">
                                                ...
                                                <h4 className="text-lg md:text-xl font-bold text-white uppercase truncate group-hover/item:text-[#F5D97A] transition-colors">
                                                    {release.title}
                                                </h4>
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8 z-10 relative">
                        <FadeIn>
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                                ...
                                <div className="lg:col-span-5 relative aspect-square rounded-3xl overflow-hidden border border-white/5 bg-[#111827]">
                                    <ImageReveal className="w-full h-full">
                                        <img
                                ...
                                <div className="lg:col-span-7 space-y-8 text-left">
                                    ...
                                    <h2 className="text-4xl sm:text-6xl md:text-[5.5rem] font-black text-white leading-[0.85] uppercase tracking-tighter">
                                        ...
                                        WHO REFUSE TO <br />
                                        SOUND LIKE <br />
                                        <span className="text-gradient-gold">EVERYONE ELSE.</span>
                                    </h2>

                                    <p className="text-[#F5E6C8]/80 text-base md:text-lg leading-relaxed max-w-xl font-light">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-mono tracking-widest text-[#D4AF37]/60">UNCOMPROMISING SONIC INTEGRITY</span>
                                    </div>
                                </div>
                ...
                <section className="py-24 border-t border-white/5 bg-[#1B1F24]/30 relative">
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <FadeIn>
                            <div className="relative overflow-hidden rounded-3xl bg-[#1B1F24] border border-[#D4AF37]/35 p-12 md:p-24 shadow-2xl flex flex-col items-center text-center space-y-8 group/productions">

                                {/* Spotlight background glow */}
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#D4AF37]/4 blur-[130px] rounded-full pointer-events-none" />

                                <span className="text-[10px] font-mono tracking-[0.25em] text-[#D4AF37] uppercase z-10">
                                    06 / NETWORK GATEWAY
                                </span>

                                <div className="space-y-4 z-10">
                                    <h3 className="text-xs md:text-sm font-bold uppercase tracking-[0.35em] text-[#F5E6C8]/60">BEYOND THE MUSIC</h3>
                                ...
                                <p className="text-[#F5E6C8]/80 text-sm md:text-base leading-relaxed max-w-2xl z-10 font-light">
                                ...
                                <div className="pt-4 z-10">
                                    <MagneticButton>
                                        <a
                                            ...
                                            className="inline-flex items-center gap-3 bg-[#111827] text-white hover:text-[#D4AF37] border border-[#D4AF37]/30 hover:border-[#D4AF37] font-bold text-sm px-10 py-5 rounded-full shadow-xl hover:shadow-[#D4AF37]/10 transition-all duration-300 hover:scale-105"
                                        >
                ...
                <section className="py-36 border-t border-white/5 bg-[#111827] relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8 text-center space-y-12 relative z-10">
                        <FadeIn>
                            ...
                            <h2 className="text-4xl sm:text-7xl md:text-8xl font-black text-white uppercase tracking-tighter leading-[0.85] max-w-5xl mx-auto">
                                HAVE A SOUND <br />
                                THE WORLD <br />
                                <span className="text-gradient-gold">NEEDS TO HEAR?</span>
                            </h2>

                            <p className="text-[#F5E6C8]/60 text-xs sm:text-sm uppercase tracking-[0.2em] font-mono">
                            ...
                            <div className="pt-8">
                                <MagneticButton>
                                    <Link
                                        to="/contact"
                                        className="inline-flex items-center gap-3 border-b-2 border-[#D4AF37] hover:border-[#F5D97A] text-2xl md:text-4xl font-black text-[#D4AF37] hover:text-[#F5D97A] pb-2 transition-colors duration-300 group"
                                    >
